...
glm::vec3 newlightPos(2.0f, 2.0f, 2.0f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Configuracion de las propiedades de la nueva luz
		glUniform3f(glGetUniformLocation(lightingShader.Program, "newlight.ambient"), 0.3f, 0.3f, 0.3f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "newlight.diffuse"), 0.3f, 0.3f, 0.3f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "newlight.specular"), 0.1f, 0.8f, 0.0f);
