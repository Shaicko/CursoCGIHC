...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 11: Animacion maquina de estados-Leonardo Berdejo", nullptr, nullptr);
...
void Animation() {
	...
	if (dogAnim == 1)  //Walk animation
	{
		...
		if (dogPos.z < 2.0f) //Condition 3: Pause before the end of the floor
			dogPos.z += 0.001f;
	}
}
